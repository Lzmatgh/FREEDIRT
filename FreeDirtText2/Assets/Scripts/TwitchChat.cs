...
public class TwitchChat : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        manager = gameObject.GetComponent<CommandManager>();
    ...
    private void Connect()
    {
        ...
        writer.WriteLine("PRIVMSG #" + channelName + " :Welcome to the game!");
